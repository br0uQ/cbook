...
class MainWindow(QMainWindow):
    ...
    def set_icons(self):
        ...
        self.buttonClearKategorien.setIcon(self.get_icon('edit-delete', QStyle.SP_DialogDiscardButton))
        self.buttonClearNahrung.setIcon(self.get_icon('edit-delete', QStyle.SP_DialogDiscardButton))
        self.buttonClearKohlenhydrate.setIcon(self.get_icon('edit-delete', QStyle.SP_DialogDiscardButton))
